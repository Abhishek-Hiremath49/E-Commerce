...
@router.delete("/{product_id}", response_model=schema.ProductRead,status_code=200)
def del_products(product_id: int, db: Session = Depends(get_db)):
    return crud.delete_products(db, product_id)